...
use crate::new_api::types::{PointOp, RawItemData};
use crate::read::io::*;
use crate::types::{CubDataId, Header};
use std::io::Read;
...
mod tests {
    ...
    fn read_item_data_from_fixture() {
        ...
        let header = crate::new_api::raw::read_header(&mut file).unwrap();

        file.seek(SeekFrom::Start(header.header_offset as u64))
            .unwrap();
        let item = crate::new_api::raw::read_item(&mut file, &header).unwrap();
